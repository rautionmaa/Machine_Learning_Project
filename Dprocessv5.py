...
# v5: creating Total_SF and dropping its components (lines 237-249)
...
def dataProcess(dataframe):
    ...
    dataframe['Total_SF'] = dataframe["GrLivArea"] + dataframe["TotalBsmtSF"]
    dataframe = dataframe.drop('TotalBsmtSF',axis=1)
    dataframe = dataframe.drop('BsmtFinSF1',axis=1)
    dataframe = dataframe.drop('BsmtFinSF2',axis=1)                                    
    dataframe = dataframe.drop('BsmtUnfSF',axis=1)                                
    dataframe = dataframe.drop('GrLivArea',axis=1)
    dataframe = dataframe.drop('1stFlrSF',axis=1)
    dataframe = dataframe.drop('2ndFlrSF',axis=1)
    dataframe = dataframe.drop('LowQualFinSF',axis=1) 
